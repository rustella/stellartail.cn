export const zhCN = {
  ...
  product: {
    ...
    body: '寻径星野聚焦出发前的准备环节。产品页以最新 iOS 端为基准，展示首页助手、装备舱、打包清单、行程轨迹、绳结技能和户外档案这些已经落到界面里的准备能力。',
    ios: {
      navLabel: 'iOS 主入口',
      eyebrow: 'iOS 当前架构',
      title: '五个底部入口，覆盖出发前的主要准备动作',
      body: 'iOS 端把轻量首页、装备管理、行程轨迹、技能复习和户外档案拆成稳定入口；继续展开 AI 助手、最近行程、装备图鉴、轨迹库、离线缓存和户外资料。',
      tabsLabel: 'iOS 五个主入口',
      tabs: [
        {
          id: 'home',
          title: '首页',
          body: '星野助手、最近行程和 AI 助手入口放在第一屏，适合先确认准备上下文。'
        },
        {
          id: 'gear',
          title: '装备',
  ...
  gear: {
    ...
    body: 'iOS 装备页显示出发装备舱，既能看装备资产、重量和存放信息，也能继续进入装备图鉴和打包清单。',
