export const zhCN = {
  ...
  hero: {
    ...
    title: '在 iPhone 上，出发前准备归入五个入口',
    subtitle: '最新 iOS 端围绕首页、装备、行程、技能、我的五个主入口组织准备流程：先看星野助手和最近行程，再逐项整理装备、清单、轨迹和绳结技能。',
    primaryCta: '查看下载入口',
    secondaryCta: '打开 Web 端',
    stats: [
      { value: '5 个', label: 'iOS 主入口' },
      { value: '轨迹', label: '行程总览' },
      { value: '缓存', label: '绳结复习' }
    ]
  },
  product: {
    eyebrow: '产品定位',
    title: '跟随 iOS 当前功能，把准备工作拆成可检查的模块',
    body: '寻径星野聚焦出发前的准备环节。产品页以最新 iOS 端为基准，展示首页助手、装备舱、打包清单、行程轨迹、绳结技能和账号档案这些已经落到界面里的准备能力。',
    ios: {
      navLabel: 'iOS 主入口',
      eyebrow: 'iOS 当前架构',
      title: '五个底部入口，覆盖出发前的主要准备动作',
      body: 'iOS 端把轻量首页、装备管理、行程轨迹、技能复习和个人设置拆成稳定入口；登录后再展开 AI 助手、最近行程、装备图鉴、轨迹库、离线缓存和账号档案。',
      tabsLabel: 'iOS 五个主入口',
      tabs: [
        {
          id: 'home',
          title: '首页',
          body: '星野助手、最近行程和 AI 额度入口放在第一屏，适合先确认准备上下文。'
        },
        {
          id: 'gear',
          title: '装备',
          body: '装备舱承接个人装备、打包清单和装备图鉴，围绕重量、状态和存放信息整理。'
        },
        {
          id: 'trips',
          title: '行程',
          body: '行程页聚合单人/多人准备、轨迹总览、轨迹库和队伍协作信息。'
        },
        {
          id: 'skills',
          title: '技能',
          body: '技能页从绳结开始，支持收藏、搜索、分类筛选和离线缓存。'
        },
        {
          id: 'profile',
          title: '我的',
          body: '个人页管理账号、户外档案、消息、主题、缓存、反馈和版本信息。'
        }
      ]
    },
    capabilities: {
      gear: {
        title: '装备舱',
        subtitle: '记录每件装备的分类、状态、重量、价值、标签和存放信息。',
        body: 'iOS 装备页把库存汇总、筛选、装备详情、添加编辑、装备图鉴和清单入口放在同一条准备链路里。',
        bullets: ['装备数量、分类、总重量和估值', '分类、状态、标签、搜索和排序', '装备图鉴可继续加入个人装备或清单']
      },
      packing: {
        title: '装备清单',
        subtitle: '按个人或公共清单逐项确认出发物品。',
        body: '打包清单来自 iOS 装备页的二级入口，支持按清单类型、天数、标签和重量查看，适合多人行程里的共享物资准备。',
        bullets: ['新建个人清单或公共清单', '按天数、标签和更新时间筛选排序', '查看总重量、已打包重量和完成度']
      },
      trips: {
        title: '行程准备',
        subtitle: '单人准备、多人协作和轨迹资产集中展示。',
        body: 'iOS 行程页展示行程轨迹总览、近期行程、创建/加入、轨迹库、地图状态和队伍模块，帮助出发前集中确认。',
        bullets: ['支持单人行程和多人行程', '轨迹总览、轨迹库和本地 3D 地图兜底', '队伍信息、公共装备和邀请协作']
      },
      skills: {
        title: '户外技能',
        subtitle: '从绳结开始，保留收藏、搜索和离线缓存。',
        body: 'iOS 技能页先展示技能目录，当前可进入绳结技能；进入列表后可按分类筛选、收藏常用绳结，并缓存内容供出发前复习。',
        bullets: ['当前能力：绳结技能', '收藏、搜索和分类筛选', '技能内容缓存与安全提示']
      }
    }
  },
  gear: {
    ...
    body: 'iOS 装备页登录后显示出发装备舱，既能看装备资产、重量和存放信息，也能继续进入装备图鉴和打包清单。',
    bullets: ['查看装备数量、分类数、总重量和估值', '按名称、品牌、型号、标签和状态筛选', '从个人装备进入图鉴或打包清单']
  },
  packing: {
    eyebrow: '装备清单',
    title: '打包清单服务个人准备，也服务队伍共享物资',
    body: 'iOS 清单页区分个人清单和公共清单，配合筛选、排序、天数和标签，把临出发前的确认动作留在手机上。',
    bullets: ['按个人或公共类型建立清单', '查看总重量、已打包重量和完成度', '按天数、标签和重量整理清单']
  },
  trips: {
    eyebrow: '行程准备',
    title: '行程页把轨迹、队伍和准备模块放在同一处',
    body: 'iOS 行程页从行程轨迹总览开始，继续进入轨迹库、行程详情、公共装备和成员协作，适合出发前做最后一次整合检查。',
    bullets: ['支持单人准备和多人协作', '查看日期、成员、天数和行程模块', '轨迹总览、地图状态、外部 App 导入指引']
  },
  skills: {
    eyebrow: '户外技能',
    title: '从绳结技能开始，做能离线复习的户外知识库',
    body: 'iOS 技能页先聚焦绳结，支持收藏、搜索、分类筛选、详情练习和缓存确认；其他技能目录保留为建设中的入口。',
    bullets: ['当前能力：绳结教程', '收藏、搜索和分类筛选', '缓存绳结内容，出发前快速复习']
  },
  screenshots: {
    ...
    iosPackingAlt: 'iOS 端打包清单界面',
    iosPackingDetailAlt: 'iOS 端清单详情界面',
    iosTripsAlt: 'iOS 端行程准备界面',
    iosTrailLibraryAlt: 'iOS 端轨迹库界面',
    iosTripDetailAlt: 'iOS 端行程地图详情界面',
    iosSkillsAlt: 'iOS 端户外技能界面',
    iosKnotListAlt: 'iOS 端绳结列表界面',
    iosKnotDetailAlt: 'iOS 端绳结详情界面',
